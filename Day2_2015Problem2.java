 ...
 * 
 */
public class Day2_2015Problem2 {
	public static void main(String args[]) {
		...
		for (int i = 0; i < dimensions.size(); i++) {
			...
			int [] dimensionArray = {length, width, height};
			Arrays.sort(dimensionArray);
			int ribbonPerim = 2*(dimensionArray[0]) + 2*(dimensionArray[1]);
			int volume = length*width*height;
			totalRibbon += ribbonPerim + volume;
		...
		System.out.println("They need to order: " + totalRibbon + " total feet of ribbon."); 
	}
